...
fun part1(input: List<String>): Int {
    ...
    // Step 2: Iterate through each line of the input.
    // Step 3: Check if the line segments is possible. Lines where either x1 = x2 or y1 = y2 is possible.
    // Step 4: Mark the boards with the points the lines cover.
    // Step 5: Repeat step 2, 3 and 4 until there are no more lines left.
